...
+ (NSString*)getEncryptedStrWithUrlString:(NSString*)URLString parameters:(NSDictionary*)parameters {
    ...
    //    WZLog(@"拼接成签名signContent：%@", signContent);
    ...
    //    WZLog(@"签名进行aes加密：%@", aesSignContent);
    //
