...
@implementation HWADScrollView
@synthesize HWAdDelegate;
...
-(void)click:(id)sender{
    [HWAdDelegate didClick:[self.pics objectAtIndex:[(UIButton *)sender tag]]];
}
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [HWAdDelegate currentPage:currentPage total:[self.pics count]-2];
